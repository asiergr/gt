...
void die_usage() {
  ...
  printf("   -enablememfwd         Enable forwarding from Memory Access (MA) stage (Default: off)\n");
  printf("   -enableexefwd         Enable forwarding from Execute (EX) stage (Default: off)\n");
  printf("   -bpredpolicy <num>    Set branch predictor  [0:Perfect 1:AlwaysTaken 2:Gselect]\n");
}
...
int32_t  BPRED_POLICY=-1; // 0:Perfect 1:AlwaysTaken 2:Gselect
